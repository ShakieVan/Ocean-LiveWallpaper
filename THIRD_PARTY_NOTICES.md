...
| Component | License |
| --- | --- |
| [Filament and gltfio 1.75.1-ocean-shadow2](https://github.com/google/filament) | [Apache 2.0](licenses/filament.txt) |
...
Gaussian shadow filter, precomputed affine cascade projection, a material
compiler hook for precomputed static scenery shadows and an ASTC LDR support
check. Native
