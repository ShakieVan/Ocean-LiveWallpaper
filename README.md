...
<img src="media/icon.png" width="112" align="right" alt="Ocean app icon: a clownfish in front of coral" />
...
> emulator successfully updated from **1.8.2 to 1.8.3** through Ocean's public
...
**1.8.4:** moving caustics on rocks and corals without the blue reflective rim
around their bases. Fish keep their wave-shaped reflections.
[Release notes](releases/v1.8.4.md).

**1.8.3:** more efficient water-light calculations, display timing, texture
transfers and fish route checks, preserving the existing appearance and settings.
[Release notes](releases/v1.8.3.md).

**1.8.2:** adjustable caustic speed, with a calmer 40% default and the previous
speed at 100%. Broader, softer light patches alternate with locally sharp edges.
[Release notes and native preview](releases/v1.8.2.md).

**1.8.1:** finer, livelier caustic light networks across fish and reef, with
wave-shaped reflections. The soft shadows keep their existing behaviour.
[Release notes and native light preview](releases/v1.8.1.md).

**1.8.0:** optional moving water light brings broader, wandering reflections;
distance-softened shadows become wider and fainter farther from their caster.
Enable either switch in **Settings**; both start off. No ray tracing.
[Release notes](releases/v1.8.0.md).

**1.7.1:** gentler fish fluorescence. For the new markings, 100% now matches
the previous 6%; contours and soft fades stay the same. If you lowered your
slider to 6%, return it to 100% after updating for the new normal fish strength.
